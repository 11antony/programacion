...
void llamaCiclo()
{
    ...
    float matriz_ventas_1[AÑOS][NUMERO_NOTAS + 1];
    float matriz_ventas_2[AÑOS][NUMERO_NOTAS + 1];
    float matriz_ventas_3[AÑOS][NUMERO_NOTAS + 1];
    ...
    float promedio_ventas_1;
    float promedio_ventas_2;
    float promedio_ventas_3;
    //Declaraciòn de matriz que almacenarà los nombres de los alumnos
    char alumnos[EMPRESAS][MAXIMA_LONGITUD_CADENA] = {"totto","wolmar","bimbo","Pepsi","coca cola"};
    ...
    do
    {
        ...
        promedio_facultad_1 = imprimirMatriz(matriz_ventas_1, empresas, "Facultad de Ingenieria"); //Despliegue de valores por facultad
        llenarMatriz(matriz_facultad_2);
        promedio_facultad_2 = imprimirMatriz(matriz_ventas_2, empresas, "Facultad de Arquitectura");
        llenarMatriz(matriz_facultad_3);
        promedio_facultad_3 = imprimirMatriz(matriz_ventas_3, empresas, "Facultad de Administracion");
        //Calculo del mejor promedio de las facultades
        if (promedio_ventas_1 > promedio_ventas_2 && promedio_ventas_1 > promedio_ventas_3)
        {
            //Facultad 1 es mayor
            cout << " La facultad con el mejor promedio es : " << "Facultad de Ingenieria" << " Promedio: " << promedio_facultad_1 << endl;
        } else
        if (promedio_ventas_1_2 > promedio_ventas_1 && promedio_ventas_2 > promedio_ventas_3)
        {
            //Facultad 2 es mayor
            cout << " La facultad con el mejor promedio es : " << "Facultad de Arquitectura" << " Promedio: " << promedio_facultad_2 << endl;
        } else
        if (promedio_ventas_3 > promedio_ventas_2 && promedio_ventas_3 > promedio_ventas_1)
        {
            //Facultad 3 es mayor
            cout << " La empresa con el mejor promedio es : " << "Facultad de Administracion" << " Promedio: " << promedio_facultad_3 << endl;
        } else
        {
